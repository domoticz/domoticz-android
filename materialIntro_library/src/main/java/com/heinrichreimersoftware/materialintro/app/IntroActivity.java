...
public class IntroActivity extends AppCompatActivity {
    ...
    private void findViews(){
        frame = findViewById(R.id.mi_frame);
        pager = findViewById(R.id.mi_pager);

        pagerIndicator = findViewById(R.id.mi_pager_indicator);
        buttonNext = findViewById(R.id.mi_button_next);
        buttonBack = findViewById(R.id.mi_button_skip);
        ...
        try {
            buttonCta = findViewById(R.id.mi_button_cta);
            if (buttonCta != null) {
